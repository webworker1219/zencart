...
*/
  public function  get_one_shipping_estimates($shipping_id,$country_id,$actual_weight,$currency_code='USD'){
    $default_currency   = $this->get_currencies_value('CNY');
	...
	$final_price_value  = $get_price_value*$perc_price+$incr_price;
	...
	$return_info        = array('pr_id'=>$shipping_id,
								...
								'remark'=>$remark,
								'shipping_price'=>$final_price_value/$default_currency/$get_currency_value,
								'shipping_fuel'=>$IncidentalPrice['fuel']/$default_currency/$get_currency_value,
								'shipping_other'=>$IncidentalPrice['other']/$default_currency/$get_currency_value
								);
	return $return_info;
  }
