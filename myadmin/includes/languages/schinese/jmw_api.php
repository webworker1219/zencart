...
define('TEXT_DISPLAY_NUMBER_OF_JMW', '显示<b>%d</b>到<b>%d</b> (共<b>%d</b>个借卖网产品)');
define('TITLE', '借卖网-产品管理');
define('TABLE_HEADER_NUMBER','ID');
define('TABLE_HEADER_PRODUCTS_NAME','产品名称');
define('TABLE_HEADING_PRODUCTS_MODEL','SKU');
define('TABLE_HEADING_STATUS', '状态');
define('TABLE_HEADING_ACTION', '操作');
define('TABLE_HEADING_TYING_NUMBER','搭配产品数量');
define('TEXT_INFO_HEADING_DELETE_TYING', '删除');
define('TEXT_SELECT_PRODUCTS','选择主产品');
define('TEXT_PRODUCTS_QUANTITY','数量');
define('TABLE_HEADER_APPLICATION','应用');
define('TEXT_SELECT_TIE_IN_PRODUCTS','选择搭配销售产品');
define('TEXT_ACTION_TITLE_SUBMIT','提交');
define('DISCOUNT_TYPE_DROPDOWN_1','折扣率(百分比)');
define('TEXT_SORT_STRING','排序');
define('TEXT_SPECIALS_IS_EFFECTIVE','特价是否有效 : ');
define('TEXT_EXPECTED_IS_EFFECTIVE','促销价是否有效 : ');
define('TEXT_YES','是');
define('TEXT_NO','否');
...
define('TEXT_INFO_EDIT_CAUTION', '点击开始编辑');
