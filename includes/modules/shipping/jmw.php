...
//      $db->Execute("update " . TABLE_COUNTRIES . " set countries_name='United States Of America' where countries_iso_code_2='US'");
    ...
    function keys() {
      $keys = array('MODULE_SHIPPING_JMW_STATUS', 'MODULE_SHIPPING_JMW_TAX_CLASS', 'MODULE_SHIPPING_JMW_TAX_BASIS', 'MODULE_SHIPPING_JMW_SORT_ORDER', 'MODULE_SHIPPING_JMW_SKIPPED', 'MODULE_SHIPPING_JMW_CURL_PROXY_REQUIRED', 'MODULE_SHIPPING_JMW_CURL_PROXY_SERVER_DETAILS');
